# Solana Airdrop Finder

> **Status:** ✅ Functional prototype | **License:** MIT | **Stack:** TypeScript + Hono

Solana Airdrop Finder for the Solana ecosystem.

## Quick Start

```bash
git clone https://github.com/Valentinasmith722/solana-airdrop-finder.git
cd solana-airdrop-finder
bun install
